...
// no updated_at, no memo — not rendered by the table/card components) —
// this is what the table/card components actually receive.
export type CustomerListItem = Pick<
  Customer,
  "id" | "owner_id" | "category" | "name" | "company" | "phone" | "email" | "created_at"
>;
